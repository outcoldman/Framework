...
sn -R "..\bin\Release\Portable\OutcoldSolutions.Presentation.dll" D:\SkyDrive\PC\Tools\OutcoldSolutions.snk
...
nuget pack "..\sources\Windows\OutcoldSolutions.Presentation\OutcoldSolutions.Presentation.csproj" -basepath "..\bin\Release" -prop Configuration=Release